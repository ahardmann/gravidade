...
public class TransformationAdapter {
	...
	public static br.com.makersf.frameworks.shared.collisioncore.pixelperfect.Transformation adapt(Transformation pTransform) {
		try {
			...
			return new br.com.makersf.frameworks.shared.collisioncore.pixelperfect.Transformation(a, d, c, b, tx, ty);
